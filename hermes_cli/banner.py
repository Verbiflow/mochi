...
_UPSTREAM_REPO_URL = "https://github.com/Verbiflow/mochi.git"
...
_RELEASE_URL_BASE = "https://github.com/Verbiflow/mochi/releases/tag"
...
def get_latest_release_tag(repo_dir: Optional[Path] = None) -> Optional[tuple]:
    ...
    canonical Verbiflow/mochi repo (forks don't get a link).
    """
...
def format_banner_version_label() -> str:
    ...
    base = f"Mochi v{VERSION} ({RELEASE_DATE})"
...
def build_welcome_banner(console: Console, model: str, cwd: str,
    ...
    left_lines.append(f"[{accent}]{model_short}[/]{ctx_str} [dim {dim}]·[/] [dim {dim}]Verbiflow[/]")
